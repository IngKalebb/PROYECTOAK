...
if (!empty($_POST)) {
  ...
  if (empty($_POST['NomUsu']) || empty($_POST['ApaUsu']) || empty($_POST['AmaUsu']) || empty($_POST['Correo']) || empty($_POST['Incrip']) || empty($_POST['Telefono']) || empty($_POST['ruta']) || empty($_POST['idtipo'])) {
    ...
    $sql_update = mysqli_query($conexion, "UPDATE usuarios SET NomUsu='$nombre', ApaUsu='$ApaUsu', AmaUsu='$AmaUsu', Correo='$correo', Incrip='$incrip', Telefono='$telefono', ruta='$ruta', idtipo='$idtipo' WHERE idusuario=$idusu");
    ...
    <div class="col-lg-6 m-auto">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" placeholder="Ingrese nombre" class="form-control" name="NomUsu" id="nombre" value="<?php echo $nombre; ?> " readonly>

        </div>
        <div class="form-group">
          <label for="ApaUsu">Apellido Paterno</label>
          <input type="text" placeholder="Ingrese apellido paterno" class="form-control" name="ApaUsu" id="ApaUsu" value="<?php echo $ApaUsu; ?>" readonly>
        </div>

        <div class="form-group">
          <label for="AmaUsu">Apellido Materno</label>
          <input type="text" placeholder="Ingrese apellido materno" class="form-control" name="AmaUsu" id="AmaUsu" value="<?php echo $AmaUsu; ?>" readonly>
        </div>
